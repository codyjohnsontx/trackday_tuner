              ...
              <li key={track.id} className="space-y-3 rounded-row bg-surface-3 p-3">
                ...
                <div className={cn('grid gap-2', !demoMode && 'grid-cols-2')}>
                  <Link
                    ...
                    className="rounded-plate bg-surface-2 px-3 py-2 text-center text-sm font-medium text-ink hover:bg-surface-3"
                  >
                    View
                  </Link>
                  {!demoMode ? (
            ...
            {seededTracks.map((track) => (
              <li key={track.id} className="rounded-row bg-surface-3 p-3">
                ...
                <div className="mt-3">
                  <Link
                    href={`/tracks/${track.id}`}
                    className="block rounded-plate bg-surface-2 px-3 py-2 text-center text-sm font-medium text-ink hover:bg-surface-3"
                  >
                    View
                  </Link>
                </div>
