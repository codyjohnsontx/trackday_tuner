...
export function WaitlistForm() {
  ...
  return (
    <form className="space-y-4" onSubmit={submit}>
      ...
      <label className="space-y-1"><span className="text-xs text-zinc-400">What do you want to learn? (optional)</span><textarea name="optional_context" maxLength={500} rows={3} className="w-full rounded-xl border border-zinc-700 bg-zinc-950 px-3 py-3 text-sm" /></label>
