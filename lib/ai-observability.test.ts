...
describe('redactForStorage', () => {
  it.each([
    ...
    ['a title-case link', 'see Trackdaytuner.Com now', 'see [url] now'],
    ['a title-case link with a path', 'see RevZilla.Com/foo now', 'see [url] now'],
    ['a title-case country link', 'see example.Co.Uk now', 'see [url] now'],
    ...
    ['a UK landline without brackets', 'call 020 7946 0958 now', 'call [phone] now'],
    ['a UK mobile', 'call 07700 900 123 now', 'call [phone] now'],
    ['an Australian mobile', 'call 0412 345 678 now', 'call [phone] now'],
    ['a German landline', 'call 030 1234 5678 now', 'call [phone] now'],
  ...
  it.each([
    ...
    ['pyrometer temperatures', 'rear temps 180 185 175'],
    ['spring rates', 'springs 95 105 110'],
    ['shift points', 'shift at 8500 9000 9500'],
    ['a session schedule', 'sessions at 0900 1030 1200'],
    ['a dashed session schedule', '0800-0930-1100'],
    ['session times', 'times 0915 1045 1215'],
