...
changed retrieved context or a changed request option. Re-record with `npm run rag:eval -- --live`,
which reads OPENAI_API_KEY from .env.local or .env unless it is already set in the shell,
